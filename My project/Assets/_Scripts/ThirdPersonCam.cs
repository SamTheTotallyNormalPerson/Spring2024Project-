...
public class ThirdPersonCam : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            Vector3 inputDir = orientation.forward * Player_Manager.GetInstance().inputVector.y + orientation.right * Player_Manager.GetInstance().inputVector.x; //The inputDir is created by using the forward direction of the orientation object multipling it by the player's vertical input, then adding it with the right direction multipling it with the player's horizontal input
