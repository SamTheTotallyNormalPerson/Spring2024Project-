...
public class Slash2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Fire1"))
        {
            ...
            {
                playerObj.transform.DODynamicLookAt(new Vector3(targetCheck.targetTransform.transform.position.x, transform.position.y, targetCheck.targetTransform.transform.position.z), 0.5f);
